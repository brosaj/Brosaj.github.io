...
function changeColor(ElemId, r1, g1, b1, r2, g2, b2, scrollFromTop) {
  ...
  var scrollFromTop = pageHeight + windowHeight * 3; //get difference between two colors
  ...
  var blueDiff = diff(b1, b2); //get unit (shade) by which the color will change by one scroll
  ...
  $(document).scroll(function () {
    ...
    var scrollTopVal = $(document).scrollTop(); //add or subtract r,g,b shades when scrolling. Example:
